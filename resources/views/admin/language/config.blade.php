        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Language Mange for country <b>{{ $language->name }}</b> and code is <b>{{ $language->code
                                }}</b>
                        ...
                        <form class="form" id="form_validation" method="post"
                            ...
                            <div class="panel-group" id="accordion_1" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading" role="tab" id="language_menu_{{ $key }}">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion_1"
                                                href="#collapse_{{ $key }}" @if ($loop->first) aria-expanded="true"
                                                @else
                                    ...
                                    <div id="collapse_{{ $key }}"
                                        ...
                                        aria-labelledby="language_menu_{{ $key }}">
                                        <div class="panel-body">
                                            <div class="row p-t-10">
                                                @foreach ($root_files_item as $keyD => $root_file_item)
                                                @php
                                                $input_name = $key . "[" . $keyD . "]";
                                                if (isset($current_file_items[$key]) &&
                                                isset($current_file_items[$key][$keyD])) {
                                                    ...
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input value="{{ $current_file_value }}"
                                                                ...
                                                                class="form-control">
                                                            <label class="form-label">{{ $root_file_item }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
