                            ...
                            <thead>
                                <tr>
                                    <td> Branch Name: &nbsp; <span class="text-bold">{{
                                            App\Transaction::find($items[0]->id)->Branch->name }}</span> </td>
                        ...
                        <table class="table  table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="text-bold">{{ $transaction->convert_money_format($item->cr) }}
                                            =/</span></td>
                        ...
                        <table class="table  table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td>Created at: &nbsp; <span class="text-bold">{{ date(
                                            config('settings.date_format').' h:i:s',
                                    ...
                                    <td>Modified at: &nbsp; <span class="text-bold">{{ date(
                                            config('settings.date_format').' h:i:s', strtotime($items[0]->updated_at))
                                            }}</span> </td>
                                </tr>
                            </thead>
                        </table>
