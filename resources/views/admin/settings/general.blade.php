                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input value="{{ $settings['company_name']  }}" name="company_name"
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input value="{{ $settings['contract_person']  }}"
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input value="{{ $settings['address_1']  }}" name="address_1"
                                                    type="text" class="form-control">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input value="{{ $settings['address_2']  }}" name="address_2"
                                                    type="text" class="form-control">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <img class="width-50 height-50" src="{{ asset($settings['company_logo'])  }} "
                                            alt="">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-line">
