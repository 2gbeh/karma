                                        ...
                                        <table class="table  table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="Language[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden" name="LedgerType[0]" value="Ledger Type">
                                                        Ledger Type
                                                    </td>
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="LedgerType[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden" name="LedgerGroup[0]" value="Ledger Group">
                                                        Ledger Group
                                                    </td>
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden" name="LedgerName[0]" value="Ledger Name">
                                                        Ledger Name
                                                    </td>
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="LedgerName[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="BankCash[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden" name="dr_voucher[0]" value="Dr Voucher">
                                                        Dr Voucher
                                                    </td>
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="dr_voucher[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input type="hidden" name="cr_voucher[0]" value="Cr Voucher">
                                                        Cr Voucher
                                                    </td>
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="cr_voucher[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="ledger[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="cash_flow[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 9; $i++) <td class="text-center">
                                                        <div class="switch">
                                                            <label>
                                                                <input name="notes[{{ $i }}]" type="checkbox"><span
                                                                    class="lever switch-col-cyan"></span>
                                                            </label>
                                                        </div>
                                                        </td>
