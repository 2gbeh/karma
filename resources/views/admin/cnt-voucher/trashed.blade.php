...
<section @if ($is_rtl) dir="rtl" @endif class="content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb breadcrumb-col-cyan @if ($is_rtl) pull-left  @else pull-right @endif">
            ...
            <li><a href="{{ route($ParentRouteName) }}"><i class="material-icons">{{ $breadcrumbMainIcon }}</i>&nbsp;{{
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <a class="btn btn-xs btn-danger waves-effect" href="{{ route($ParentRouteName) }}">{{
                            __('root.common.trash') }}({{ $items->count() }})</a>
                            ...
                            <table class="table table-hover table-bordered table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('root.contra_voucher.amount') }} (
